...
// CONFIGURATION
// ============================================
// EmailJS Credentials - Replace with your actual credentials from emailjs.com
const EMAILJS_PUBLIC_KEY = 'd7weGsiaz1UdiWzBV';
const EMAILJS_SERVICE_ID = 'service_wfmghtc';
const EMAILJS_TEMPLATE_ID = 'template_hug3k2b';
...
function initFormHandling() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        if (EMAILJS_PUBLIC_KEY === 'YOUR_PUBLIC_KEY' || EMAILJS_SERVICE_ID === 'YOUR_SERVICE_ID' || EMAILJS_TEMPLATE_ID === 'YOUR_TEMPLATE_ID') {
            console.warn('EmailJS credentials are not set. Running in simulation mode.');
            // Simulate form submission
            await new Promise(resolve => setTimeout(resolve, 1500));
            showSuccessState(btn, originalContent);
            form.reset();
            return;
        }
    ...
    // Helper function for success feedback
    function showSuccessState(btn, originalContent) {
        btn.innerHTML = `
    ...
    function showErrorState(btn, originalContent) {
        btn.innerHTML = `
